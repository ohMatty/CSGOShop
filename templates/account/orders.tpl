...
<ul class="pager">
	{% if page_num > 0 %}
	<li class="previous"><a href="{{ config('core.url') }}/account/orders/active?p={{ page_num - 1 }}">&larr; Newer</a></li>
	{% endif %}
	{% if (page_num + 1) < total %}
	<li class="next"><a href="{{ config('core.url') }}/account/orders/active?p={{ page_num + 1 }}">Older &rarr;</a></li>
	{% endif %}
</ul>
{% endblock %}